CLASS lhc_zr_trap100_fvf DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    CONSTANTS:
    ...
    METHODS:
      get_global_authorizations FOR GLOBAL AUTHORIZATION
        IMPORTING
        REQUEST requested_authorizations FOR ZrTrap100Fvf
        RESULT result,
      earlynumbering_create FOR NUMBERING
        IMPORTING entities FOR CREATE ZrTrap100Fvf,
      setStatusToOpen FOR DETERMINE ON MODIFY
        IMPORTING keys FOR ZrTrap100Fvf~setStatusToOpen,

      validateCustomer FOR VALIDATE ON SAVE
        IMPORTING keys FOR ZrTrap100Fvf~validateCustomer.

    METHODS validateDates FOR VALIDATE ON SAVE
      IMPORTING keys FOR ZrTrap100Fvf~validateDates.
    METHODS deductDiscount FOR MODIFY
      IMPORTING keys FOR ACTION ZrTrap100Fvf~deductDiscount RESULT result.
    METHODS copyTravel FOR MODIFY
      IMPORTING keys FOR ACTION ZrTrap100Fvf~copyTravel.
    METHODS acceptTravel FOR MODIFY
      IMPORTING keys FOR ACTION ZrTrap100Fvf~acceptTravel RESULT result.

    METHODS rejectTravel FOR MODIFY
      IMPORTING keys FOR ACTION ZrTrap100Fvf~rejectTravel RESULT result.
    METHODS get_instance_features FOR INSTANCE FEATURES
      IMPORTING keys REQUEST requested_features FOR ZrTrap100Fvf RESULT result.
ENDCLASS.

CLASS lhc_zr_trap100_fvf IMPLEMENTATION.
  METHOD get_global_authorizations.
  ENDMETHOD.
  METHOD earlynumbering_create.
    DATA:
      entity           TYPE STRUCTURE FOR CREATE zr_trap100_fvf,
    ...
    LOOP AT entities INTO entity WHERE TravelID IS NOT INITIAL.
      APPEND CORRESPONDING #( entity ) TO mapped-ZrTrap100Fvf.
    ENDLOOP.
        ...
        CATCH cx_number_ranges INTO DATA(lx_number_ranges).
          LOOP AT entities_wo_travelid INTO entity.
            APPEND VALUE #(  %cid      = entity-%cid
                          ...
                          ) TO reported-ZrTrap100Fvf.
            APPEND VALUE #(  %cid      = entity-%cid
                             %key      = entity-%key
                             %is_draft = entity-%is_draft
                          ) TO failed-ZrTrap100Fvf.
          ENDLOOP.
          EXIT.
      ENDTRY.
    ...
    ELSE.
      ...
      SELECT SINGLE FROM ztrap100_fvf FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM ztrap100_fvf_d FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
  ...
  METHOD setStatusToOpen.
    ...
    READ ENTITIES OF zr_trap100_fvf IN LOCAL MODE
     ENTITY ZrTrap100Fvf
    ...
    MODIFY ENTITIES OF zr_trap100_fvf IN LOCAL MODE
      ENTITY ZrTrap100Fvf
  ...
  METHOD validateCustomer.
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-CustomerID IS  INITIAL.
        APPEND VALUE #( %tky = travel-%tky ) TO failed-ZrTrap100Fvf.
  ...
  METHOD validateDates.
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      APPEND VALUE #(  %tky               = travel-%tky
                       %state_area        = 'VALIDATE_DATES' ) TO reported-ZrTrap100Fvf.
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        %state_area        = 'VALIDATE_DATES'
                         %msg              = NEW /dmo/cm_flight_messages(
                                                                ...
                                                                severity = if_abap_behv_message=>severity-error )
                        %element-BeginDate = if_abap_behv=>mk-on ) TO reported-zrtrap100fvf.
      ENDIF.
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        %state_area        = 'VALIDATE_DATES'
                         %msg                = NEW /dmo/cm_flight_messages(
                                                                ...
                                                                severity = if_abap_behv_message=>severity-error )
                        %element-EndDate   = if_abap_behv=>mk-on ) TO reported-ZrTrap100Fvf.
      ENDIF.
  ...
  METHOD deductDiscount.
    DATA travels_for_update TYPE TABLE FOR UPDATE zr_trap100_fvf.
    ...
    LOOP AT keys_with_valid_discount ASSIGNING FIELD-SYMBOL(<key_with_valid_discount>)
      ...
      APPEND VALUE #( %tky                       = <key_with_valid_discount>-%tky ) TO failed-ZrTrap100Fvf.
  ...
  METHOD copyTravel.
    DATA:
        travels       TYPE TABLE FOR CREATE zr_trap100_fvf\\ZrTrap100Fvf.
    ...
    mapped-ZrTrap100Fvf   =  mapped_create-ZrTrap100Fvf .
  ENDMETHOD.
