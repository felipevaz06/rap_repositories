CLASS zcl_rap100_gendata_fvf DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RAP100_GENDATA_FVF IMPLEMENTATION.
...
*   clear data
    DELETE FROM ztrap100_fvf. "#EC CI_NOWHERE

    "insert travel demo data
    INSERT ztrap100_fvf  FROM (
        SELECT
